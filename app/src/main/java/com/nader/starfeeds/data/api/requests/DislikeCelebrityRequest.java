...
public class DislikeCelebrityRequest extends ApiRequest {

    public Single<ApiResponse> dislikeCeleb(@NonNull String userId, @NonNull String celebId) {
        // base url
        String url;
        url = ApiConfig.getApiHost() + "/api/dislike";
        // raw params //
