...
public class FeedFacebookImage extends Feed {
    ...
    public FeedFacebookImage(JSONObject jsonObject) throws JSONException {
        super(FeedType.FACEBOOK_IMAGE,jsonObject.getString("id"),jsonObject.getString("celebName"),jsonObject.getString("celebId"),jsonObject.getString("text"),jsonObject.getString("date"),jsonObject.getString("imageProfile"));
        try {
