...
public class UnFollowCelebrityRequest extends ApiRequest {

    public Single<ApiResponse> unFollowCeleb(@NonNull String userId, @NonNull String celebId) {
        // base url
        String url;
        url = ApiConfig.getApiHost() + "/un-follow";
        // raw params //
