...
public class FeedTwitterLink extends Feed {
    ...
    public FeedTwitterLink(JSONObject jsonObject) throws JSONException {
        super(FeedType.TWITTER_LINK, jsonObject.getString("id"), jsonObject.getString("celebName"),jsonObject.getString("celebId"), jsonObject.getString("text"), jsonObject.getString("date"),jsonObject.getString("imageProfile"));
        try {
