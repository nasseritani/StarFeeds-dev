...
public class UserNewFeedsRequest extends ApiRequest {

    public Single<ApiResponse> fetchNewUserFeeds(@NonNull String id, String postId) {
        // base url
        String url;
        url = ApiConfig.getApiHost() + "/new-user-feeds/" + id +"/"+ postId;
        // create request
