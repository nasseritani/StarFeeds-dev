...
public class FeedInstagramVideo extends Feed {
    ...
    public FeedInstagramVideo(JSONObject jsonObject) throws JSONException {
        super(FeedType.INSTAGRAM_VIDEO,jsonObject.getString("id"),jsonObject.getString("celebName"),jsonObject.getString("text"),jsonObject.getString("date"),jsonObject.getString("imageProfile"));
        try {
