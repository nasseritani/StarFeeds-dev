...
public class FeedInstagramImage extends Feed {
    ...
    public FeedInstagramImage(JSONObject jsonObject) throws JSONException {
        super(FeedType.INSTAGRAM_IMAGE,jsonObject.getString("id"),jsonObject.getString("celebName"),jsonObject.getString("text"),jsonObject.getString("date"),jsonObject.getString("imageProfile"));
        try {
