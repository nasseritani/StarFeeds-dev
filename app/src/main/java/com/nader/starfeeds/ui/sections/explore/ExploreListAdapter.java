...
public class ExploreListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ExploreListAdapter(ArrayList<ListingItem> items, OnListListener listener, Context ctx) {
        if (items != null) {
            this.items = items;
        }
        this.ctx = ctx;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        else if(viewType == ListingItemType.FeedFacebookImage.ordinal()||viewType == ListingItemType.FeedInstagramImage.ordinal() || viewType == ListingItemType.FeedTwitterLink.ordinal()||viewType == ListingItemType.FeedFacebookVideo.ordinal()||viewType == ListingItemType.FeedFacebookLink.ordinal()||viewType == ListingItemType.FeedTwitterImage.ordinal()){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (item.getType()) {
            ...
            case FeedTwitterLink:
                FeedTwitterLinkItem feedTwitterLinkItem = (FeedTwitterLinkItem) item;
            ...
            case FeedFacebookLink:
                FeedFacebookLinkItem feedFacebookLinkItem = (FeedFacebookLinkItem) item;         // get article from item container
        ...
        FeedViewHolder(final View view) {
            ...
            ivFeed.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(view.getContext(),ExploreDetailActivity.class);
                    intent.putExtra(ExploreDetailActivity.FEED,items.get(getAdapterPosition()).getFeed());
