...
import com.nader.starfeeds.ui.tools.Adapters.ImageListAdapter;
...
public class ExploreFragment extends Fragment {
    ...
    private FeedsProvider.OnFeedsProviderListener feedsProviderListener =
            new FeedsProvider.OnFeedsProviderListener() {
                ...
                public void onComplete(ArrayList<Feed> arrayFeeds, int currentCount) {
                    Log.i("nn", "complete");
                    mImageListAdapter.removeLastItem();
    ...
    private void handleNewDataFeeds(ArrayList<Feed> arrayFeeds, int currentCount) {
        ...
        mImageListAdapter.addNewItems(newListingItems);
        // update mThreshold
        if (mItemsCount == 0) {
    ...
    private void addLoaderItem() {
        ...
        mImageListAdapter.addNewItem(loaderItem);
    }
    /**
    ...
    private void addReloaderItem(NetworkErrorType error){
        ...
        mImageListAdapter.addNewItem(reloaderItem);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mImageListAdapter = new ImageListAdapter(null, listListener, getActivity());//create new adapter
